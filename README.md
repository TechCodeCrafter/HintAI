...
For the full design (listening, persistence, benchmarks, known gaps), see **[ARCHITECTURE.md](./ARCHITECTURE.md)**. For build order and vocabulary, see **[ROADMAP.md](./ROADMAP.md)**. For tenant isolation and RLS decisions, see **[docs/TENANT-ISOLATION.md](./docs/TENANT-ISOLATION.md)**.
