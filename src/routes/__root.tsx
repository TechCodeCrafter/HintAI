...
import { MEETHINT_DESCRIPTION, MEETHINT_NAME, MEETHINT_TITLE } from "@/lib/brand";
import { MEETHINT_CANONICAL_URL, shareOgHeadMeta } from "@/lib/og/share-meta";
import "../fonts.css";
...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      { rel: "canonical", href: MEETHINT_CANONICAL_URL },
